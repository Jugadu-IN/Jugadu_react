      ...
      <div className="carousel-inner" role="listbox">
        ...
        <div className="carousel-item active">
          <div className="testimonial">
            ...
            <p>
              <i className="fas fa-quote-left"></i> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod
              eos
        ...
        <div className="carousel-item">
          <div className="testimonial">
            ...
            <p>
              <i className="fas fa-quote-left"></i> Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
              odit
        ...
        <div className="carousel-item">
          <div className="testimonial">
            ...
            <div className="avatar mx-auto mb-4">
              <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(3).jpg" className="rounded-circle img-fluid"
                alt="Third sample avatar image"/>
            </div>
            <p>
              <i className="fas fa-quote-left"></i> Duis aute irure dolor in reprehenderit in voluptate velit esse
