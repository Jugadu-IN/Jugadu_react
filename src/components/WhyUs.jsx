...
function WhyUs(){
    ...
    <h2 className="text-center pt-5 Heading" style={{fontSize:"50px"}} >Increase your business with <br /> us</h2>
    ...
    Whether you just have a new business idea or have an established business, we have something for everyone.
...
<ReactBootStrap.Card.Text>
We only rest after all our customers are 100% satisfied with their product.
100% satisfaction guaranteed.
    ...
    <ReactBootStrap.Card.Text style={{color: "#707b8e",lineHeight:"30px"}} >
    We take all your ideas and suggestions into account and we only deliver the best products.
    </ReactBootStrap.Card.Text>
    </ReactBootStrap.Card.Body>
    </ReactBootStrap.Card>
    </div>
