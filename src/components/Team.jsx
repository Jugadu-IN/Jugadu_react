...
function Team(props){
  ...
  <Link to={props.link} style={{textDecoration:"none"}}> <img style={{widh:"100%",textAlign:"center",marginTop:"0%"}} style={{ borderRadius: "50%" }} src={props.image} width="255px" height="256px" />
